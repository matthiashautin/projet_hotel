...
if (isset($_POST['add'])) {
    ...
    try {
        ...
        $stmt = $db->prepare("INSERT INTO Reservation (Hebergement_ID, Client_ID, Restauration_ID, Animation_ID, Region_ID, Menage, DateDebut, DateFin) VALUES (:Hebergement_ID, :Client_ID, :Restauration_ID, :Animation_ID, :Region_ID, :Menage, :DateDebut, :DateFin)");
