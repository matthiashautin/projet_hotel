...
<div class="modal fade" id="edit_<?php echo $row['ID']; ?>" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <form method="POST" action="../Modele/admin_region/edit.php?ID=<?php echo $row['ID']; ?>">
            <div class="mb-3 row">
                <label class="col-sm-2 col-form-label">Nom_Region</label>
            <div class="col-sm-10">
                <input type="text" class="form-control" name="Nom_Region" value="<?php echo $row['Nom_Region']; ?>">
            </div>
        </div>
        </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <h2 class="text-center"><?php echo $row['Nom_Region']; ?></h2>
      </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fermer</button>
            <a href="../Modele/admin_region/delete.php?ID=<?php echo $row['ID']; ?>" class="btn btn-danger"> Oui</a>
        </div>
    </div>
  </div>
</div>