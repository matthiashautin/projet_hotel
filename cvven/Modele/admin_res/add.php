...
if (isset($_POST['add'])) {
    ...
    try {
        ...
        $_SESSION['message'] = ($stmt->execute(array(':Hebergement_ID' => $_POST['Hebergement_ID'], ':Client_ID' => $_POST['Client_ID'], ':Restauration_ID' => $_POST['Restauration_ID'], ':Animation_ID' => $_POST['Animation_ID'], ':Region_ID' => $_POST['Region_ID'], ':DateDebut' => $_POST['DateDebut'], ':DateFin' => $_POST['DateFin'],))) ? "Nouvelle Réservation ajouté avec succès" : "Une erreur s'est produite. Impossible d'ajouter cette Réservation";
