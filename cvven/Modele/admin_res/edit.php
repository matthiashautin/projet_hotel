...
if (isset($_POST['edit'])) {
    ...
    try {
        ...
        $sql = "UPDATE Reservation SET Hebergement_ID = '$Hebergement_ID', Client_ID  = '$Client_ID', Restauration_ID  = '$Restauration_ID', Animation_ID = '$Animation_ID', Region_ID = '$Region_ID ', DateDebut = '$DateDebut' , DateFin = '$DateFin' WHERE ID = '$id'";
