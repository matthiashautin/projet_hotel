<?php
    ...
    if(isset($_POST['add'])){
        ...
        try{
            ...
            $stmt = $db->prepare("INSERT INTO Hebergement (Chambres_doubles, Chambres_3_Lits, Chambres_4_Lits, Logement_Handi, Ménage) VALUES (:Chambre_Doubles, :Chambres_3_Lits, :Chambres_4_Lits, :Logement_Handi, :Ménage)");
